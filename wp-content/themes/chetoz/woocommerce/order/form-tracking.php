...
<div class="order-tracking">
    <form action="<?php echo esc_url(get_permalink($post->ID)); ?>" method="post" class="woocommerce-form woocommerce-form-track-order track_order">
        ...
        <p><?php esc_html_e('To track your order, enter your Order ID in the box below and click the "Track" button. You can find your Order ID on your receipt and in the confirmation email sent to you.', 'woocommerce'); ?></p>
        <div class="tracking-form">
            <p class="form-row"><label for="orderid"><?php esc_html_e('Order ID', 'woocommerce'); ?></label> <input class="input-text" type="text" name="orderid" id="orderid" value="<?php echo isset($_REQUEST['orderid']) ? esc_attr(wp_unslash($_REQUEST['orderid'])) : ''; ?>" placeholder="<?php esc_attr_e('Found in your order confirmation email.', 'woocommerce'); ?>" /></p>
